		...
		<section id="primary">
			<div id="content" role="main">
				...
				<header class="page-header">
					<h1 class="page-title author"><?php printf( __( 'Author archives: <span class="vcard">%s</span>', 'thurston' ), "<a class='url fn n' href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a>" ); ?></h1>
				</header>
